...
- 说明: AI 驱动的代码编辑器，Howie 极力推荐。
- 链接: [Cursor](https://cursor.com/)

**工具 2**: Runway

- 说明: 视频生成工具，Howie 用来观察 AI 的前沿边界。
- 链接: [Runway](https://runwayml.com/)

**工具 3**: Replit

- 说明: 用于快速构建原型。
- 链接: [Replit](https://replit.com/)

**工具 4**: HeyGen

- 说明: 用于制作 AI 数字人视频。
- 链接: [HeyGen](https://www.heygen.com/)
...
**推荐阅读 1**: Thinking, Fast and Slow

- 说明: Daniel Kahneman 著，组织架构灵感来源。
- 链接: [Amazon](https://www.amazon.com/Thinking-Fast-Slow-Daniel-Kahneman/dp/0374275637)

**推荐阅读 2**: The Three-Body Problem

- 说明: Howie 推荐的思维扩展读物。
- 链接: [Amazon](https://www.amazon.com/Three-Body-Problem-Cixin-Liu/dp/0765377063)
...
_来源_: Lenny's Podcast | _嘉宾_: Howie Liu | _分析生成_: 2024-05-22
